...
using ShoppingCoreRepository;
using System;
using System.Collections.Generic;
using System.Linq;
using System.Threading.Tasks;

namespace ShoppingCoreApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "ShoppingCoreApi", Version = "v1" });
            });
            ...
            {
                options.UseSqlServer(Configuration.GetConnectionString("ShoppingDb"), b => b.MigrationsAssembly("ShoppingCoreApi"));
            });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "ShoppingCoreApi v1"));
            }
